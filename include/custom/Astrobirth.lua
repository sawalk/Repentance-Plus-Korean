return {
	items = {
		...
		["Super Nova"] = {
			name = "초신성",
			description = "광활한 별들의 폭발"
		},
		["Taurus EX"] = {
			name = "초 황소자리",
			description = "..."
		},
		["Technology Omicron EX"] = {
			name = "테크놀로지 오미크론 EX",
			description = "..."
		},
		["TERRA EX"] = {
